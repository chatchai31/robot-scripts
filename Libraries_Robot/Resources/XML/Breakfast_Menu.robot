...
# นับ Tag จากด้านนอก สู่ ด้านใน ซึงด้านนอกจะมี 1 Tag ชื่อ breakfast_menu
    ${menu_count} =  Get Element Count  ${XML_MENU_PATH}
    Should Be Equal As Numbers  ${menu_count}  ${EXPECTED_MENU_COUNT}

Verify Menu Name
# ตรวจสอบชื่อ tag ว่าตรงกับ breakfast_menu หรือไม่
...
# นับ tag ชื่อ food ซึ่งมีอยู่ทั้งหมด 5 Tag
